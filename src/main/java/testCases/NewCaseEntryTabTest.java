...
public class NewCaseEntryTabTest {
	...
	public void addNewCaseEntry(Hashtable<String,String> data)
	{
		
		if(!TestUtil.getrunmode("NewCaseEntryTabTest", xls))
		...
		try {
			k.executekeywords("NewCaseEntryTabTest", xls, data);
	...
	{
		return TestUtil.getdata("NewCaseEntryTabTest", xls);
