...
public class COBNewCaseEntryTabTest {
	...
	public void doLogin(Hashtable<String,String> data)
	{
		...
		if(!TestUtil.getrunmode("COBNewCaseEntryTabTest", xls))
		...
		try {
			k.executekeywords("COBNewCaseEntryTabTest", xls, data);
	...
	{
		return TestUtil.getdata("COBNewCaseEntryTabTest", xls);
